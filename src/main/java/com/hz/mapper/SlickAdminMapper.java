...
public interface SlickAdminMapper {
     ...
     * @return
     */
    public SlickAdmin getSlickAdmin(@Param("slickAdmin")SlickAdmin slickAdmin);
     ...
     * @return
     */
    public int editSlickAdmin(@Param("slickAdmin")SlickAdmin slickAdmin);
